package com.supaki.marketplace.config.db;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.supaki.marketplace.data.repository"})
public class MasterdbConfig extends AbstractPoolConfiguration {

    @Bean("rawMasterDataSourceProperties")
    @ConfigurationProperties("db.supaki.datasource")
    @Primary
    ...
    public LocalContainerEntityManagerFactoryBean entityManager(EntityManagerFactoryBuilder entityManagerFactoryBuilder,
        ...
        return createEntityManagerFactory(entityManagerFactoryBuilder, dataSource, new String[]{"com.supaki.marketplace.data"},
                "rawMaster");
    }
